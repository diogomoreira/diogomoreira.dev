---
title: Unveiling my hardware/software setup
...
Hello there! In this post, I want to share with you the tools that I have been using on my workflow and helped me become more productive and efficient. This is a always evolving post, so I'll try to keep track of what has changed through the years and why.
...
- **Insomnia**. I used Postman a lot before, however, Insomnia is managing to meet all my needs lately, I can't give a specific reason for switching.
