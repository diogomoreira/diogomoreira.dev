  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>Software Engineering</strong> in 2015 and my master&apos;s
        degree in the same field from 2017 to 2019, during which I discovered my
        passion for <strong>Software Testing</strong>. Currently, I teach
        subjects related to <strong>Software Engineering</strong>,{" "}
      ...
      <p>
        ...
        science fiction and fantasy themes. I&apos;m a football fan and support
        São Paulo FC. I also love traveling, experiencing new cultures, trying
        new things, and most importantly, spending time with friends and family
