...
const Footer = () => {
  ...
  return (
    <footer className="bg-base-300 dark:bg-base-200 text-xs">
      <div className="flex flex-col md:flex-row justify-between md:px-10 py-4 items-center container mx-auto max-w-4xl gap-6">
        <div>
