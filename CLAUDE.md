...
| Section                          | Notes                                                                                                                                                                                                                                       |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `blog/`                          | Page bundles (`slug/index.md`). Front matter: `cover`, `tags`, `categories`, `credits`, `disclaimer`, `status` (`seed`/`growing`/`living`/`archived` — idea/project maturity, rendered as an emoji via `post-status-emoji.html`/`post-status-badge.html`).                                                                                                                                       |
