...
In general, we should think of class design as falling into two types:
...
Furthermore, `sealed` aims to allow the author of a class or interface to control which code is responsible for implementing it and to provide a more declarative way than access modifiers (such as `public` or `protected`...) to restrict the use of a superclass.
